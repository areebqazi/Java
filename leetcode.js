...
const languages = {
              ...
              */
              ...
              if (code != null) {
                setTimeout(function () {
                  ...
                  api_data.code=code
                  console.log(api_data) // data extracted 
                  uploadGit(
  ...
  function parseQuestion() {
    ...
    api_data.questionURL=questionUrl
    ...
    if (checkElem(questionElem)) {
      ...
      api_data.difficulty=difficulty
  ...
  function parseStats() {
    ...
    api_data.time=time
    api_data.time_p=timePercentile
    api_data.space=space
    api_data.space_p=spacePercentile
    ...
    if (
      ...
      setTimeout(function () {
        ...
        if (
          ...
          api_data.currentDate=currentDate
    ...
    if (probStatement !== null) {
      ...
      if (language !== null) {
        ...
        chrome.storage.local.get('stats', (s) => {
          ...
          console.log( "third last upload call ")
          api_data.question=probStatement
            uploadGit(
        ...
        if (notes.length > 0) {
          ...
          console.log( "second last upload call ")
